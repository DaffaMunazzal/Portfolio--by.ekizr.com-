...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      submitData.append('_subject', 'New Contact Message from Portfolio'); // Subjek email
  ...
  return (
    <div className="px-[5%] sm:px-[5%] lg:px-[10%] " >
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        ...
        >
          Have a question or want to work together? Feel free to reach out by filling the form below or connect with me on social media. I look forward to hearing from you!
        </p>
      </div>
            ...
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <p className="text-gray-400">
                  Want to discuss a project  or just say hello? Feel free to drop a message!
                </p>
              </div>
