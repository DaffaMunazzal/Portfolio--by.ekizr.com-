...
const Header = memo(() => (
  <div className="text-center lg:mb-8 mb-2 px-[5%]">
    ...
    >
      ...
      Building a better future through code and creativity
      <Sparkles className="w-5 h-5 text-purple-400" />
    </p>
  </div>
));
...
const AboutPage = () => {
  ...
  const { totalProjects, totalCertificates, YearExperience } = useMemo(() => {
    ...
    const experience = today.getFullYear() - startDate.getFullYear() -
      (today < new Date(today.getFullYear(), startDate.getMonth(), startDate.getDate()) ? 4 : 0);
          ...
          <div className="space-y-6 text-center lg:text-left">
            ...
            >
              ...
              <span
                ...
                itemProp="name"
              >
                Muhammad Daffa Oemarqois Munazzal
              </span>
            </h2>
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              I'm Information System student at Institut Widya Pratama Pekalongan, with a passion for Aerospace Computer Science and Data Science. I have experience in web development, data analysis, and machine learning, and I'm eager to apply my skills to solve real-world problems. I'm committed to continuous learning and growth in the aerospace and motorsport industry, and I'm excited about the opportunities ahead.
            </p>
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/drive/folders/1C7HIdUXQ6xe95VJoBL-OS4VvhG-vzUe3?usp=sharing" className="w-full lg:w-auto">
                <button
                  data-aos="fade-up"
                  data-aos-duration="800"
