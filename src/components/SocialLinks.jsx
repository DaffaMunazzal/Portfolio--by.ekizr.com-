...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/daffamunazzal/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@daffa_mnzal",
    icon: Instagram,
    url: "https://www.instagram.com/daffa_mnzal?igsh=MXF0dDNsZ2o2dmN2Nw==",
    color: "#E4405F",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@DaffaMunazzal",
    icon: Github,
    url: "https://github.com/DaffaMunazzal",
    color: "#ffffff",
